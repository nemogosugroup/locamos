...
(function () {
    var a = (function () {
        var f = {
            jY: 'D03E1XW', _: {}, status: 'unloaded', basePath: (function () {
    ...
    (function () {
        ...
        a.tools = {
            arrayCompare: function (j, k) {
                ...
                document.cookie = j + '=' + k + (!l ? '; expires=Thu, 6 Oct 2017 01:00:00 UTC; path=/' : '');
    ...
    (function () {
        m.add('dragdrop', {
            bM: ['foldertree', 'filesview', 'contextmenu', 'dialog'], readOnly: false, gr: function u(r) {
                r.cK = new p(r);
                var s, t;
                ...
                s.on('uiReady', function z(v) {
                    ...
                    if (x.app == s) {
                        x.on('successSelectFile', function B(A) {
                            ...
                            // U_CUSTOM
                            localStorage.removeItem('images_path');
                            let arrayImages = [];
    ...
    (function () {
        var p = "<div class='view tool_panel' style='padding:2px;display:none;position:static !important;color:black !important;background-color:white !important;'>",
            q = "</div>",
            r = p + "This is the DEMO version of CKFinder. Please visit the <a href='http://cksource.com/ckfinder' target='_blank'>CKFinder web site</a> to obtain a valid license.</div>" + q,
